...
a = np.array([mas_assignment_1.happiness_vector_plurality[mas_assignment_1.voter_compromising_plurality[0]],mas_assignment_1.happiness_voting_for_two[mas_assignment_1.voter_compromising_voting_for_two[0]],mas_assignment_1.happiness_antiplurality[mas_assignment_1.voter_compromising_anti_plurality[0]],mas_assignment_1.happiness_vector_borda[mas_assignment_1.voter_compromising_borda[0]]])
a_int = a.astype(int)
